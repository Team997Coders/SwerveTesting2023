...
public class SwerveModuleConstants {
    ...
    public final double angleMotorKP;

    public SwerveModuleConstants(int driveMotorID, int angleMotorID, double angleEncoderOffsetRadians, Boolean driveMotorIsInverted, Boolean angleMotorIsInverted, Boolean angleEncoderIsInverted, Boolean driveEncoderIsInverted, double angleMotorKP) {
        ...
        this.angleMotorKP = angleMotorKP;
    }
}
